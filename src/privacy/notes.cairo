...
mod tests {
    use starknet::ContractAddress;
    use super::{
        Note, ShieldedPosition, create_note, create_shielded_position, is_valid_note,
        is_valid_position, note_to_commitment, note_to_nullifier_hash, update_position_fees,
